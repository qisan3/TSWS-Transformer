...
class Options(object):
    ...
    def __init__(self):
        ...
        # Model
        self.parser.add_argument('--model', choices={"transformer", "LINEAR", "cnn_transformer"}, default="transformer",
                                 help="Model class")
        ...
        self.parser.add_argument('--cnn_channels', type=str, default='64,128',
                                 help='Comma-separated list of channel sizes for the CNN Downsampler/Upsampler blocks')
    ...
    def parse(self):
        ...
        if args.val_pattern is not None:
            args.val_ratio = 0
            args.test_ratio = 0
        args.cnn_channels = [int(i) for i in args.cnn_channels.split(',')]
        assert len(args.cnn_channels) == 2, "cnn_channels must be a comma-separated list of 2 integers (e.g., '64,128')"
